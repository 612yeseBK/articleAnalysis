 ...
 */
public class CpjgModelHandler {
    public CpjgModelHandler() {
    }

    public WscpjgModel jxWscpjgModel(WsAnalyseImpl wsAnalyse, List<WssscyrModel> wssscyrModellist, AjlxEnum ajlxEnum) {
    ...
    public static WscpjgModel setMsysjafs(WscpjgModel wscpjgModel, String pjjgnr, String allPjjg, WsAnalyseImpl wsAnalyse) {
        if (!StringUtil.equals(pjjgnr, "")) {
            List<String> cpfxgc = wsAnalyse.getCpfxgc();
            String cpfxgcStr = "";
            String s;
    ...
    public static void setCsrjh(WscpjgModel wscpjgModel, List<WssscyrModel> wssscyrModellist, String cpjg, WsAnalyseImpl wsAnalyse) {
