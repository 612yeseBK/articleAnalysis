...
import template.service.BaseModelService;
...
public class BaseModelServiceImpl implements BaseModelService{
    ...
    @Override
    public WswsModel jxWswsModel(List<String> var1) {
        return null;
    }

    @Override
    public List<WssscyrModel> jxWssscyrModelList(List<String> var1, List<String> var2) {
        return null;
    }

    @Override
    public List<WsajjbqkModel> jxWsajjbqkModel(List<String> var1) {
        return null;
    }

    @Override
    public WscpfxgcModel jxWscpfxgcModel(List<String> var1) {
        return null;
    }

    @Override
    public WscpjgModel jxWscpjgModel(List<String> var1) {
        return null;
    }

    @Override
    public WswwModel jxWswwModel(List<String> var1) {
        return null;
    }
