...
public class WsajjbqkModel {
    private String qsdl;
    private String qsygscd;  //前审原告诉称段
    private String qsbgbcd;  //被告辩称段
    private String qsdsryjd;  //
    private List<String> qszjd;
    private List<String> qssld;
    private String qsfsscd;
    private String qspjd;
    private String bsdl;
    private String ssrscd;
    private List<String> bssrbcd;
    private String bsdsryjd;
    private List<String> bssld;
    private List<String> bszjd;
    private String ygscd;
    private String bgbcd;
    private List<String> cmssd;
    private List<String> zjd;  //证据段
    ...
    private String zkzj;
    private String zkyj;
    private List<String> bgrbc;
    private List<String> bhrbh;
    ...
    private String tbxz;  //投保性质
    private String sfzbxqn;  //
    private String sfxqpf;
    private String shangQing;
    private String realPay;
    private String identifyContent;
    private String jdsfkk;

    public WsajjbqkModel() {
    }
