...
public class WsssjlModel {
    ...
    private String ktsl;
    private String aydm;
    private ArrayList<String> ktrq;
    private ArrayList<String> qsah;
    private String qsfy;
    private String ktslxx;
    private String bgkslyy;
    private String larq;
    private String ysajsycx;
    private String jyzpt;
    private String ysajly;
    private String slrq;
    private String spzz;
    private String drsp;
    private String sqcsrq;
    private HashMap<String, String> qxrxx;
    private HashMap<String, String> ctrxx;
    private String qsrq;
    private String bgzyldct;
    private String xzxwzl;
    private String xzqqxwzl;
    private String jysyjycx;
    private String msbfjxsl;
    private String ssxz;
    private String jcy;
    private String js;
    private ArrayList<WsssjlZkjlModel> wsssjlZkjl;
    private String qszay;
    private String gsjg;
    private String gsah;
    private String slztqfdmsss;
    private String jcyjyyqsl;
    private String snft;
    private String xzesqsah;
    private String qsland;
    private String qsfyjc;
    private String fyjb;
    private String qsahsxh;
    private String qscpsj;
    private String qswszl;
    private String qsajyl;
    private String qsjafs;
    private String qssj;
    private String sshksfw;
    private String qspj;
    private String xsesqsah;
    private String bzfymc;
    private String qsgsjg;
